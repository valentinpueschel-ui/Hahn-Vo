...
(function () {
  ...
  drawer.innerHTML =
    ...
    '<div class="cd-foot" data-cd-foot>' +
      ...
      '<p class="cd-note">Inkl. MwSt. — differenzbesteuert nach § 25a UStG. Versicherter Versand oder persönliche Übergabe im Showroom, Abstimmung im nächsten Schritt.</p>' +
