...
2. **Lokal starten.** `lsof -i :8440` prüfen; läuft nichts, `./serve.command` (Port 8440 — feste Vergabe, andere Projekte belegen 8408/8412/8418/8420/8433). Änderungen unter `http://localhost:8440` ansehen.
